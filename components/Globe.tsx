...
export function Globe() {
  ...
  return (
    <div className="flex flex-row items-center justify-center py-20 h-screen md:h-auto dark:bg-black light:bg-white relative w-[100vw]">
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-full md:h-[40rem]">
        ...
        >
          ...
          <p className="text-center text-base md:text-lg font-normal text-neutral-700 light:text-black dark:text-neutral-200 max-w-md mt-2 mx-auto">
            Flexible and Available for Communication Across All Time Zones :)
          </p>
        </motion.div>
